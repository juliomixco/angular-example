...
/***/ "../../../../../src/app/modules/product/components/index.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__product_list_product_list_component__ = __webpack_require__("../../../../../src/app/modules/product/components/product-list/product-list.component.ts");
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_0__product_list_product_list_component__["a"]; });
...
/***/ "../../../../../src/app/modules/product/components/product-list/product-list.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"head text-center\">\n  <!--<img src=\"http://clipart-library.com/data_images/250409.jpg\" width=\"200\" alt=\"Elvis Store\" />\n        <br />-->\n\n  <h2>Product List</h2>\n  <br />\n</div>\n<div class=\"col-md-offset-3 col-md-6\">\n  <div class=\"form-group form-inline\">\n    <label for=\"search-box\">Product filter</label>\n    <input #searchBox id=\"search-box\" class=\"form-control\"  (keyup)=\"search(searchBox.value)\" placeholder=\"Type something! \" />\n  </div>\n  <table class=\"table table-striped table-bordered\">\n    <thead>\n      <tr class=\"info\">\n        <th>Name</th>\n        <th> Price</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let p of products | async\">\n        <td>{{p.name}}</td>\n        <td>{{p.cost | currency:\"USD\":true}}</td>\n      </tr>\n    </tbody>\n  </table>\n</div>\n<!--<div class=\"col-md-offset-3 col-md-6\" >\n\n    <div class=\"form-group form-inline\">\n      <label for=\"filt\">Product filter</label>\n      <input id=\"filt\" class=\"form-control\" ng-model-options=\"{ debounce: 500 }\" [(ngModel)]=\"filter\"  placeholder=\"Type something! \" />\n    </div>\n    <table class=\"table table-striped table-bordered\">\n      <thead>\n        <tr class=\"info\">\n          <th>Name</th>\n          <th> Price</th>\n        </tr>\n      </thead>\n      <tbody>\n        <tr *ngFor=\"let p of products\">\n          <td>{{p.name}}</td>\n          <td>{{p.cost | currency:\"$\"}}</td>\n        </tr>\n      </tbody>\n    </table>\n\n  </div>-->"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_product_service__ = __webpack_require__("../../../../../src/app/modules/product/services/product.service.ts");
...
var ProductListComponent = (function () {
    function ProductListComponent(http, productService) {
        this.http = http;
        this.productService = productService;
        this.apiURL = '/api';
        this.products = __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["Observable"].of([]);
    }
    ProductListComponent.prototype.ngOnInit = function () {
        this.searchfilter = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Rx__["BehaviorSubject"](""); //initial filter value
        this.setProductSubject();
        // setTimeout(() => this.search(""), 0);
    };
    ProductListComponent.prototype.setProductSubject = function () {
        var _this = this;
        this.products = this.searchfilter
            .debounceTime(300) // wait 300ms after each keystroke before considering the term
            .distinctUntilChanged() // ignore if next search term is same as previous
            .switchMap(function (term) {
            return _this.productService.search(term);
        })
    ...
    ProductListComponent.prototype.search = function (term) {
...
ProductListComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["S" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/modules/product/components/product-list/product-list.component.html"),
        styles: [__webpack_require__("../../../../../src/app/modules/product/components/product-list/product-list.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_product_service__["a" /* ProductService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_product_service__["a" /* ProductService */]) === "function" && _b || Object])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_modules_product_components__ = __webpack_require__("../../../../../src/app/modules/product/components/index.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_routing_module__ = __webpack_require__("../../../../../src/app/modules/product/product-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components__ = __webpack_require__("../../../../../src/app/modules/product/components/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__("../../../forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_modules_product_services_product_service__ = __webpack_require__("../../../../../src/app/modules/product/services/product.service.ts");
...
var components = [
    __WEBPACK_IMPORTED_MODULE_4__components__["a" /* ProductListComponent */]
];
...
ProductModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        ...
        // exports: [...components],
        providers: [__WEBPACK_IMPORTED_MODULE_6_app_modules_product_services_product_service__["a" /* ProductService */]]
    })
], ProductModule);
